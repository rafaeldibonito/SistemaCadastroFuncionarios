 ...
 */
public class TelaEditarCbo extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form TelaEditCbo
     */
    public TelaEditarCbo() {
        initComponents();
        conexao = ModuloConexao.conector();
    }

    // Criando método para alterar dados CBO na tabela cbo
    private void editar() {
        String sql = "update cbo set setor = ?, numero_cbo = ?, funcao_cbo = ?, funcao_empresa = ? where id_cbo = ?";
        try {
            ...
            pst.setString(5, txtCboId.getText());
            ...
            if (((txtCboSetor.getText().isEmpty()) || (txtCboNumCbo.getText().isEmpty()) || (txtCboFuncaoCbo.getText().isEmpty()) || (txtCboFuncaoEmpresa.getText().isEmpty()))) {
                ...
                // as linha abaixo atualiza a tabela cbo com os dados do formulário
    ...
    // Criando método para setar os campos do formulário com o conteúdo da tabela cbo
    public void setar_campos() {
        int setar = tabelaCbo.getSelectedRow();
        txtCboId.setText(tabelaCbo.getModel().getValueAt(setar, 0).toString());
        txtCboSetor.setText(tabelaCbo.getModel().getValueAt(setar, 1).toString());
        txtCboNumCbo.setText(tabelaCbo.getModel().getValueAt(setar, 2).toString());
        txtCboFuncaoCbo.setText(tabelaCbo.getModel().getValueAt(setar, 3).toString());
        txtCboFuncaoEmpresa.setText(tabelaCbo.getModel().getValueAt(setar, 4).toString());
    ...
    private void initComponents() {
        ...
        tabelaCbo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelaCboMouseClicked(evt);
            }
        });
        ...
        btnEditarCbo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEditarCboActionPerformed(evt);
            }
        });
    ...
    private void tabelaCboMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaCboMouseClicked
        // Chama o método setar_campos
        setar_campos();
    }//GEN-LAST:event_tabelaCboMouseClicked
    ...
    private void btnEditarCboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarCboActionPerformed
        // Chama o método editar
        editar();
    }//GEN-LAST:event_btnEditarCboActionPerformed
