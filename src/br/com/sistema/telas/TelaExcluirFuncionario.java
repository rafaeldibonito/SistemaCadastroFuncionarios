...
public class TelaExcluirFuncionario extends javax.swing.JInternalFrame {
    ...
    private void excluir() {
        // a estrutura abaixo confirma a exclusão do funcionário
        int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir o funcionário " + txtCadNome.getText() + "?", "Atenção!", JOptionPane.YES_NO_OPTION);
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Excluir dados funcionário");
        ...
        btnExcluirFun.setFont(new java.awt.Font("Times New Roman", 3, 14)); // NOI18N
        btnExcluirFun.setForeground(new java.awt.Color(0, 102, 204));
        btnExcluirFun.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sistema/icones/excluir.png"))); // NOI18N
        btnExcluirFun.setText("Excluir");
        btnExcluirFun.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
