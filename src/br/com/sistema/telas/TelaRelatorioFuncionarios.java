...
public class TelaRelatorioFuncionarios extends javax.swing.JInternalFrame {
    ...
    public TelaRelatorioFuncionarios() {
        ...
        listarFuncionarios(); // Chama o método carregarTabela()
    }
    ...
    private void initComponents() {
        ...
        tabelaFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOME", "DATA NASCIMENTO", "SEXO", "NACIONALIDADE", "ESTADO NASCIMENTO", "NATURALIDADE", "COR", "ESTADO CIVIL", "EMAIL", "TELEFONE", "NOME DO PAI", "NOME DA MÃE", "CEP", "ENDEREÇO", "NÚMERO RESIDÊNCIA", "BAIRRO", "CIDADE", "ESTADO", "ESCOLARIDADE", "OBS_ DADOS PESSOAIS", "CPF", "RG", "DATA EXPEDIÇÃO RG", "CTPS", "CTPS SÉRIE", "CTPS UF", "PIS", "RESERVISTA", "CNH", "CNH CATEGORIA", "CNH VENCIMENTO", "TITULO ELEITOR", "TITULO ELEITOR ZONA", "TITULO ELEITOR  SESSÃO", "OBS_DOCUMENTOS", "CONTRATO", "MATRÍCULA ESOCIAL", "DATA ADMISSÃO", "DATA DEMISSÃO", "CARGO", "SALÁRIO", "SETOR", "CBO 2002", "OBS_CONTRATO", "BANCO", "AGÊNCIA", "CONTA", "OBS_DADOS BANCÁRIO"
            }
        ));
        tabelaFuncionarios.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        ...
        jLabel1.setText("Funcionários Empresa");
    ...
    private void btnGerarExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarExcelActionPerformed
        ...
        try {
            ...
            excel.exportarExcel(tabelaFuncionarios);
        } catch (Exception e) {
        }
