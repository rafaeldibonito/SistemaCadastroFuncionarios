 ...
 */
public class TelaExcluirCbo extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form TelaExcCbo
     */
    public TelaExcluirCbo() {
        initComponents();
        conexao = ModuloConexao.conector();
    }

    // Método para excluir CBO da tabela cbo
    private void excluir() {
        // a estrutura abaixo confirma a exclusão da função CBO
        int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir a função " + txtCboFuncaoEmpresa.getText() + "?", "Atenção!", JOptionPane.YES_NO_OPTION);
        if (confirma == JOptionPane.YES_OPTION) {
            String sql = "delete from cbo where id_cbo = ?";
            try {
                pst = conexao.prepareStatement(sql);
                pst.setString(1, txtCboId.getText());
    ...
    private void initComponents() {
        ...
        btnExcluirCbo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnExcluirCboActionPerformed(evt);
            }
        });
    ...
    private void btnExcluirCboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirCboActionPerformed
        // Chama o método Excluir
        excluir();
    }//GEN-LAST:event_btnExcluirCboActionPerformed
